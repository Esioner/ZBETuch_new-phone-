package com.youli.zbetuch.jingan.bean.personalInfoBean;
...
public class PersonalInfoBean {
    ...
    @SerializedName("NO")
    private String no;
    @SerializedName("NOW_LANE")
    private String nowLane;
    @SerializedName("NOW_NO")
    private String nowNo;
    @SerializedName("NOW_ROAD")
    private String nowRoad;
    @SerializedName("NOW_ROOM")
    private String nowRoom;
    @SerializedName("POLITICAL")
    private String political;
    @SerializedName("RESIDE_TYPE")
    ...
    public String getNowLane() {
        return nowLane;
    }

    public void setNowLane(String nowLane) {
        this.nowLane = nowLane;
    }
